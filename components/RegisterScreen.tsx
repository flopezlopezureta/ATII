...
const PasswordRequirements: React.FC = () => (
    <div className="text-xs text-slate-500 space-y-1 mt-2 p-2 bg-slate-50 rounded-md">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input type="tel" id="phone" name="phone" value={profileData.phone} onChange={handleProfileChange} className="w-full px-4 py-2 border border-slate-300 rounded-lg"/>
                    </div>
                     <div>
